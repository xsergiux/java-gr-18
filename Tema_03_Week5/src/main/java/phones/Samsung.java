...
public abstract class Samsung implements Phone {
    ...
    public Samsung(String color, String material, int batteryLife,  String imei) {
        this.color = color;
    ...
    public void sendMessage(String phoneNumber, String message) {
        if (consumptionOfBattery >= batteryLife) {
            System.out.println("Attention! You don't have enough battery to send another message");
        }
